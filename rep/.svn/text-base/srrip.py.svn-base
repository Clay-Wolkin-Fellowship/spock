...
# Run command example:
# python3 srrip.py ../traces/ls.mtrace ../results/ls.srrip -o 2 -i 8 -w 4 -m 2
...
# default starting age (should be long according to paper, 2^M - 2 (long))
agestart = 2**M - 2
...
for line in input:
        ...
        if samefound == 1: 
                ...
                ## This is where the replacement algorithm matters
                        ...
                        # this one has now been added, make the age 'agestart'
